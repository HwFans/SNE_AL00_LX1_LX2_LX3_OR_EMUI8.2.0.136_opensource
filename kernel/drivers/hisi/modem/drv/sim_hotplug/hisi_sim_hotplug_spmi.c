...
static int sim_hotplug_dts_init(struct hisi_sim_hotplug_info *info, struct device_node *np)
{
    ...
    LOGI("%s: sim%d, allocate_gpio: %d, shared_det_irq: %d, send_msg_to_cp: %d, send_card_out_msg: %d, card_tray_style: %s,factory_send_msg_to_cp: %d\n",
            __func__, sim_id, allocate_gpio, shared_det_irq,
            send_msg_to_cp, send_card_out_msg,
            card_tray_style_to_string(card_tray_style),factory_send_msg_to_cp);
